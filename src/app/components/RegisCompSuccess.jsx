    ...
    <>
      ...
      <section  className={`${styles.flexCenter} ${styles.marginY} ${styles.padding} ${styles.marginX} sm:flex-col flex-col bg-black-gradient-2 rounded-[20px] box-shadow` }>
        ...
        <div className={`flex text-center justify-center flex-col`}>
          ...
          <a href="https://chat.whatsapp.com/FLKZyndkSbTCbS9YCTwHfq"><img src={whatsapp.src} alt="whatsapp" className={`sm:h-28 h-24 ${styles.marginY}`}/></a>
        </div>
        <div className={`flex items-center-center justify-center flex-col`}>
          ...
          <div className="flex justify-around items-center sm:flex-row flex-col">
            <a href="https://www.facebook.com/JEC.JLUG"><img src={facebook2.src} alt="facebook" className={`sm:h-28 h-24 ${styles.marginY}`}/></a>
            <a href="https://www.instagram.com/jlug_jec/"><img src={instagram2.src} alt="instagram" className={`sm:h-28 h-24 ${styles.marginY}`}/></a>
            <a href="https://www.linkedin.com/company/jlug-jec/"><img src={linkedin2.src} alt="linkedin" className={`sm:h-28 h-24 ${styles.marginY}`}/></a>
          </div>
        </div>
      </section>
    </>
