...
const Billing = () => (
  <section id="jecaa" className={layout.sectionReverse} >
    <div className={layout.sectionImgReverse}>
      <img src={JECAA.src} alt="JECAA" className="w-[300px] h-[300px] relative z-[5] " />
    ...
    <div className={layout.sectionInfo}>
      ...
      <a href="https://www.jecalumni.org/user/login.dz" target="_blank"><JeccaButton styles={`mt-10`}/></a>
      </p>
    </div>
  </section>
);
