        ...
        <div className={`flex justify-center align-middle ${styles.paddingX}`}>
          <div className=" max-w-md sm:w-full p-6 bg-white rounded-lg shadow-md bg-black-gradient-2">
            ...
            >
              <input
                required
                className={`w-full bg-white p-3 mb-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 focus:animate-pulse transition-all`}
                type="text"
                name="fullName"
              ...
              <select
                required
                className={`w-full bg-white mb-2 p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 focus:animate-pulse transition-all`}
                name="branch"
              ...
              <select
                required
                className={`w-full mb-2 bg-white p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-300 focus:animate-pulse transition-all`}
