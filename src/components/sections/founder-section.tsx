...
import { founderMembers } from '@/constants/founders';

const FounderSectionComponent = () => {
  const responsive = {
    superLargeDesktop: {
  ...
  return (
    <>
      <section className="py-16 md:py-20 lg:py-24 px-8 md:px-16 lg:px-24 xl:px-32 bg-gradient-to-b from-black  to-gray-900">
...
export default FounderSectionComponent;
