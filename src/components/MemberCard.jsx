  ...
  return (
    <div className="my-5 mx-10 text-white">
            <div className="basis-64 group lg:flex lg:flex-col lg:items-center">
                <img src={props.profile} className='h-64 w-64 rounded-full sm:grayscale cursor-pointer transition-all sm:group-hover:grayscale-0' />
                <h3 className="mt-7 text-2xl">{props.name}</h3>
